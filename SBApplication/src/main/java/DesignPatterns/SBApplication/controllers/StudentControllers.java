package DesignPatterns.SBApplication.controllers;

import java.util.List;

import DesignPatterns.SBApplication.Beans.Student;
import DesignPatterns.SBApplication.Services.HobbyService;
import DesignPatterns.SBApplication.Services.StudentService;
